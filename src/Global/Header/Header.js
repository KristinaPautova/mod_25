        ...
        <Fragment>
            <header>
                <nav className="menu__frame is-desktop">
                    ...
                    <Link to="/registration" className="menu__frame-link is-animated is-active"  rel="nofollow">О нас</Link>
                    <Link to="/" className="menu__frame-link is-animated"  rel="nofollow">Условия</Link>
                    <Link to="/" className="menu__frame-link is-animated" rel="nofollow">Частые вопросы</Link>
